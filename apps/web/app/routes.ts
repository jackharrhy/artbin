...
export const routes = route({
  ...
  api: route("/api", {
    ...
    commitUpload: post("/uploads/:uploadId/commit"),
    uploadJob: get("/uploads/jobs/:jobId"),
    finalizeUploads: post("/uploads/finalize"),
    extractUpload: post("/uploads/:uploadId/extract"),
    import: post("/import"),
    lucky: post("/lucky"),
    folder: post("/folder"),
